...
if (isset($_GET['action'])) {
    ...
    if ($action == "add") {
        ...
        if (isset($_SESSION['cart'])) {
            ...
            $_SESSION['cart'][$id]['TenHH'] = $product['name'];
            $_SESSION['cart'][$id]['soluong'] =  1;
            $_SESSION['cart'][$id]['image'] =  $product['image'];
            $_SESSION['cart'][$id]['price'] =  $product['price'];
        }
...
<div class="header">
    ...
    <div class="container">
        ...
        <div class="cart">
            ...
            <div class="body " id="cart" style="text-align:left;">
                ...
                <tbody>
					<?php	
                      ...
                      foreach ($product as $key => $row) {
						...
						echo '
                        <tr>
                            <td class="product-img" rowspan = "2"> <img src="' . $row['image'] . '" alt="" height="150px" width="125px"></td>
                            <td class="product-name" colspan = "2"><h4>' . $row['name'] . ' </h4></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td class="product-price"><h4 style="margin-top:-50px;"> $ ' . $row['price'] . ' </h4></td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td class="product-soluong"><h5 style="text-align:center; margin-top: -20px;"><img src="./assets/img/minus.png" alt="" height="10px" width="10px"> ' . $row['soluong'] . ' <img src="./assets/img/plus.png" alt="" height="10px" width="10px"></h5></td>
                            <td>
                            <div class="circle">
